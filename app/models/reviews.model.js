...
Reviews.getAll = (room_id, result) => {
  let query = `SELECT reviews.id, cus.fullname, cus.phonenumber, cus.email, reviews.content, reviews.image, reviews.rating, reviews.status, reviews.createdAt FROM reviews
